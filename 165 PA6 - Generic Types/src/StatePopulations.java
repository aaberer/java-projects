   ...
   public static void main(String[] args) throws IOException {
      ...
      for (i = 0; i < zipCodeState.size(); ++i) {
        if (zipCodeState.get(i).getValue1() == myZipCode){
            stABV = zipCodeState.get(i).getValue2();
            break;
        }
      }
      ...
      for (i = 0; i < abbrevState.size(); ++i) {
        if (abbrevState.get(i).getValue1().equals(stABV)){ //zipCodeState.get(i).getValue2()
            stNAME = abbrevState.get(i).getValue2();
            break;
        }
      }
      ...
      for (i = 0; i < statePopulation.size(); ++i) {
        if (statePopulation.get(i).getValue1().equals(stNAME)){ //abbrevState.get(i).getValue2()
            StatePair<String, Integer> sp = statePopulation.get(i);
            sp.printInfo();
            break;
        }
      }
