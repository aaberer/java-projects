...
public class GardenHelper {
    ...
    /*
        ...
        The method addPlant takes the user input as args "plantName" and "row".
        It then runs a set of conditional statements to check if the plant is able
        to be planted by calling other method checks inside the conditional. First
        instance the row function looks for avaiable row and assignes values to the
        GardenHelper constructor. Else outputs the plant was unsucessfully planted
     */
