...
public class NumberPattern {
    ...
    //continually until a negative value is reached, and then continually add the second integer
    //until the first integer is again reached. For this lab, do not end output with a newline.
