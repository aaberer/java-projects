...
public class Recursion {
    ...
    public static boolean isPalindrome(String word){
        ...
        if (Character.toUpperCase(word.charAt(0)) == Character.toUpperCase(word.charAt(word.length() - 1))){
    ...
    public static int longestWordLength(String words){
        ...
        int longest = 0;
        return scannerNext(longest, scnr);
    }

    public static int scannerNext(int longest, Scanner scnr){
        if (!scnr.hasNext()){
            return longest;
        }
        else {
            String word = scnr.next().replaceAll("[^a-zA-Z]", "");;
    ...
    public static String dedupeChars(String word){
        ...
        if (Character.toUpperCase(word.charAt(0)) == Character.toUpperCase(word.charAt(1))){
